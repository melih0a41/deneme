...
-- Basitleştirilmiş network kodları
...
util.AddNetworkString("gScooters.Net.CloseScooterUI")
...
net.Receive("gScooters.Net.CloseScooterUI", function(len, pPlayer)
    ...
    if IsValid(eScooter) and activeScooterUIs[eScooter] == pPlayer then
        ...
        DebugPrint("UI lock released for scooter by", pPlayer:Nick())
    end
end)
...
net.Receive("gScooters.Net.PickupScooter", function(len, pPlayer)
    ...
    -- Scooter'ın gerçekten toplanabilir olup olmadığını kontrol et
