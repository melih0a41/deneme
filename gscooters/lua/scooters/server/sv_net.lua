...
-- gScooters Van Pickup Fix
-- sv_net.lua dosyasında "gScooters.Net.PickupScooter" bölümünü bulup aşağıdaki kod ile değiştirin
...
net.Receive("gScooters.Net.PickupScooter", function(len, pPlayer)
    ...
    -- SCOOTER'I TOPLA
    print("[gScooters] All checks passed, picking up scooter...")
