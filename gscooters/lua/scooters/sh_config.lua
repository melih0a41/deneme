-- sh_config.lua dosyasının EN BAŞINA bu satırı ekleyin:
...
-- DebugMode ekliyoruz - production'da false yapabilirsiniz
gScooters.Config.DebugMode = true -- false yapın production'da
