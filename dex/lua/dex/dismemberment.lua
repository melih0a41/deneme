...
-- RemoveRagdollAndRespawnPlayer fonksiyonunda, öldürme tamamlandığında sanity yenile
function ENT:RemoveRagdollAndRespawnPlayer()
    ...
    if IsValid(self.LastAttacker) and self.LastAttacker:IsPlayer() then
        ...
        -- SANITY YENİLEME - YENİ!
        if DEX_CONFIG.SanitySystemEnabled then
            RefreshSanityAfterKill(attacker)
        end
