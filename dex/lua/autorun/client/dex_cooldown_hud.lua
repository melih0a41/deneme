...
hook.Add("HUDPaint", "dex_DrawCooldownPanel", function()
    ...
    local panelX = screenW - panelW - 30
    local panelY = 30
    ...
    -- Renk değerlerini güvenli şekilde kullan
    ...
    draw.SimpleText(percentText, "dex_CooldownLabel", panelX + panelW - 15, barY - 15, 
