...
CH_ATM.Config.ForgetCardFee = 10000 -- How much should they be fined for getting their credit card in the ATM?

CH_ATM.Config.SlideMoneyOutOfATM = true -- Should we spawn money and slide them in/out of the ATM on deposit/withdraw? If not it just adds directly to wallet.
CH_ATM.Config.OnlyOwnerCanTakeMoney = true -- Should we only allow the person that withdraws the money to be able to take the money that slides out of the ATM?
...
CH_ATM.Config.PoliceTeams = { -- The DarkRP team name that defines the police teams on your server (put the names as shown on your scoreboard).
	...
	["SWAT"] = true,
	["SWAT Sıhhiye"] = true,
	["SWAT Keskin Nişancı"] = true,
	["SWAT Komutanı"] = true,
	["SWAT Keskin Nişancı"] = true,
	["SWAT Ağır Zırhlı Kuvvet"] = true,	
}
...
CH_ATM.Config.CriminalTeams = { -- The DarkRP team name that defines who can hack/lockpick ATM's (put the names as shown on your scoreboard).
	...
	["Paralı Asker Lideri"] = true,
	["Profesyonel Adam Kaçırıcı"] = true,
	["Profesyonel Kapkaççı"] = true,		
}
...
--]]
CH_ATM.Config.InterestInterval = 1800 --Once a player joins this interval starts to count. Every x second it will generate a percentage interval based on the config.

CH_ATM.Config.InterestToTakeOnBankRobbery = 0.5 -- SUPPORT FOR BANK ROBBERY 2 AND PVAULT How much interest to take from all players when bank is robbed
CH_ATM.Config.MoneyPercentToTakeOnBankRobbery = 0.5 -- SUPPORT FOR BANK ROBBERY 2 AND PVAULT How many percent of a players bank account money should we take from all players when bank is robbed
...
CH_ATM.Config.MoneyRewardForHackingMin = 10000 -- Minimum amount of money to be "rewarded" for hacking an ATM.
CH_ATM.Config.MoneyRewardForHackingMax = 50000 -- Maximum amount of money to be "rewarded" for hacking an ATM.

CH_ATM.Config.InterestToTakeForHacking = 0.1 -- How much interest to take from all players when an ATM is hacked?
...
CH_ATM.Config.PlayerWantedTime = 180 -- For how long should we make him wanted?

CH_ATM.Config.UnwantedAfterHacking = false -- Once hacking finishes (success or failed) do we make him unwanted?

CH_ATM.Config.KillHackerReward = 7000 -- How much money is rewarded if a police officer kills a hacker?
CH_ATM.Config.ArrestHackerReward = 10000 -- How much money is rewarded if a police officer arrests a hacker?
