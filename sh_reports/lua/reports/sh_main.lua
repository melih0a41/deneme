-- sh_main.lua'ya eklenecek yeni network mesajı (diğer CLIENT -> SERVER mesajlarının arasına ekleyin)

-- Mevcut ClaimAndTeleport'tan sonra ekleyin:
easynet.Start("SH_REPORTS.ClaimAndStartSit")
	easynet.Add("id", EASYNET_UINT32)
easynet.Register()

-- Bu mesaj zaten mevcut ClaimAndTeleport mesajından sonra CLIENT -> SERVER bölümüne eklenmelidir.
-- Tam dosya için:
...
easynet.Start("SH_REPORTS.ReportCreated")
	...
	easynet.Add("created_time", EASYNET_UINT32)
easynet.Register()
...
easynet.Start("SH_REPORTS.PeriodicNotification")
	easynet.Add("count", EASYNET_UINT16)
easynet.Register()

easynet.Start("SH_REPORTS.AutoShowReport")
	easynet.Add("report_id", EASYNET_UINT32)
easynet.Register()

easynet.Start("SH_REPORTS.DirectShowReport")
	easynet.Add("id", EASYNET_UINT32)
	easynet.Add("reporter_id", EASYNET_STRING)
	easynet.Add("reporter_name", EASYNET_STRING)
	easynet.Add("reported_id", EASYNET_STRING)
...
easynet.Start("SH_REPORTS.TeleportToReport")
	easynet.Add("id", EASYNET_UINT32)
	easynet.Add("action", EASYNET_STRING) -- "goto" veya "bring"
easynet.Register()

-- YENİ: Üstlendikten sonra sit başlatma
easynet.Start("SH_REPORTS.StartSitForReport")
	easynet.Add("id", EASYNET_UINT32)
easynet.Register()


-- YENİ: Sit başlatma için
easynet.Start("SH_REPORTS.ClaimAndStartSit")
	easynet.Add("id", EASYNET_UINT32)
easynet.Register()
