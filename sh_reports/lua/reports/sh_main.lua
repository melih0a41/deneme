...
-- YENİ: Admin rating penceresi için
easynet.Start("SH_REPORTS.ShowReportRating")
	easynet.Add("report_id", EASYNET_UINT32)
	easynet.Add("reporter_name", EASYNET_STRING)
	easynet.Add("reporter_id", EASYNET_STRING)
easynet.Register()
...
easynet.Start("SH_REPORTS.TeleportToReport")
	easynet.Add("id", EASYNET_UINT32)
	easynet.Add("action", EASYNET_STRING)
easynet.Register()
...
-- YENİ: Admin rating ile kapatma
easynet.Start("SH_REPORTS.CloseReportWithRating")
	easynet.Add("report_id", EASYNET_UINT32)
	easynet.Add("admin_rating", EASYNET_UINT8)
easynet.Register()
