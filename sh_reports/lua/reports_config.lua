...
/**
* YENİ: SPAM KORUMASI SİSTEMİ
**/

-- Rapor açtıktan sonra bekleme süresi (saniye)
SH_REPORTS.ReportCooldown = 120 -- 2 dakika

-- Cooldown süresinde verilen mesaj
SH_REPORTS.CooldownMessage = "Yeni rapor açmak için %d saniye beklemelisiniz!"

/**
* YENİ: REPORTED OYUNCU BİLDİRİMİ
**/

-- Hakkında rapor açılan oyuncuya bildirim gönderilsin mi?
SH_REPORTS.NotifyReportedPlayer = true

-- Reported oyuncuya çalınacak ses
SH_REPORTS.ReportedPlayerSound = Sound("buttons/button15.wav")

/**
* YENİ: ADMIN AFK KORUMASI
**/

-- Admin raporu üstlenip işlem yapmazsa kaç dakika sonra serbest kalsın?
SH_REPORTS.AdminAFKTimeout = 1800 -- 5 dakika (saniye cinsinden)

-- AFK uyarısı kaç dakika sonra verilsin?
SH_REPORTS.AdminAFKWarning = 1500 -- 4 dakika (saniye cinsinden)

/**
* YENİ: GÜVEN SKORU SİSTEMİ
**/

-- Güven skoru sistemi aktif mi?
SH_REPORTS.TrustScoreEnabled = true

-- Başlangıç güven skoru
SH_REPORTS.DefaultTrustScore = 100

-- Güven skoru değişimleri (Admin değerlendirmesine göre)
SH_REPORTS.TrustScoreChanges = {
	[5] = 10,  -- Tamamen haklı: +10 puan
	[4] = 5,   -- Haklı: +5 puan
	[3] = 0,   -- Kısmen haklı: değişim yok
	[2] = -5,  -- Gereksiz: -5 puan
	[1] = -10  -- Troll/Spam: -10 puan
}

-- Düşük güven skoru eşiği
SH_REPORTS.LowTrustThreshold = 30

-- Düşük güven skorlu oyuncuların rapor önceliği düşürülsün mü?
SH_REPORTS.LowTrustLowPriority = true
