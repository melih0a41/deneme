...
//General Settings \\
SWEP.Author 			= "Phantaso"                           -- Your name.
SWEP.Contact 			= ""                     		-- How Pepole chould contact you.
...
SWEP.PrintName 			= "Ise"                         	-- your sweps name.
SWEP.Category 			= "Phantaso Swep"                		-- Make your own catogory for the swep.
SWEP.ReloadSound 		= ""           							-- Reload sound.
SWEP.Instructions 		= "Sol Tıkla İşe"              	-- How do pepole use your swep.
