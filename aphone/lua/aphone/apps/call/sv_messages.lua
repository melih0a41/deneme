...
local function add(user1, user2, body, is_friends)
    ...
    if !is_friends then
        ...
        aphone.SQLQuery("INSERT INTO aphone_Friends (user1, body, timestamp, last_name) VALUES(" .. user1_id .. ", " .. aphone.SQLEscape(body) .. ", " .. time .. ", " .. aphone.SQLEscape(user1:Nick()) .. ")")
        ...
        if aphone.Webhook and aphone.Webhook != "" then
            http.Post(aphone.URLsend_discord or "https://akulla.dev/aphone/send_discord.php", {
