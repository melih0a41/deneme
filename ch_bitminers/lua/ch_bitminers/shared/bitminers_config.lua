...
-- Bitminer Values
CH_Bitminers.Config.BitcoinRate = 12500 -- 1 bitcoin equals how much cash? (1 bitcoin = 6808)
...
CH_Bitminers.Config.MinBitcoinRate = 4500 -- The lowest the bitcoin rate can hit.
CH_Bitminers.Config.MaxBitcoinRate = 7500 -- The maximum the bitcoin rate can go to.
...
-- Bitminer Shelf
CH_Bitminers.Config.DefaultBitcoinsMinedPer = 0.25 -- Amount of bitcoins mined on each interval by default (any rank that is not in the table below will fallback to this.
...
CH_Bitminers.Config.EnableEjectingBitminers = false -- Should ejecting bitminers be enabled or disabled?
...
-- Fuel Generator
CH_Bitminers.Config.GeneratorWattsInterval = 1 -- Interval for the fuel generator to generate watts in seconds.
...
CH_Bitminers.Config.GeneratorWattsMin = 400 -- Minimum amounts of watts generated per interval
CH_Bitminers.Config.GeneratorWattsMax = 800 -- Maximum amounts of watts generated per interval (IT'S RANDOMIZED)

-- Solar Panel
CH_Bitminers.Config.SolarPanelWattsInterval = 1 -- Interval for the solar panel to generate watts in seconds.
...
CH_Bitminers.Config.SolarPanelWattsMin = 5000 -- Minimum amounts of watts generated per interval
CH_Bitminers.Config.SolarPanelWattsMax = 6000 -- Maximum amounts of watts generated per interval (IT'S RANDOMIZED)

CH_Bitminers.Config.CollectDirtInterval = 45 -- Amount of seconds between collecting more dirt on the solar panel.
CH_Bitminers.Config.CollectDirtMin = 0 -- Minimum amount of dirt collected per interval.
CH_Bitminers.Config.CollectDirtMax = 0 -- Maximum amount of dirt collected per interval.
