...

	{
...

		{
...

			{
				...
				{
					{
						Label = "Pick Up Deployed Crackers",
						Value = "pick_up",
						Icon = "icon16/arrow_up.png",
						Tip = "Allow this group to pick up deployed keypad crackers?",
						Default = true
					},
					
					{
						Label = "Remove/Cancel Crackers",
						Value = "remove",
						Icon = "icon16/cancel.png",
						Tip = "Allow this group to remove or cancel other players' keypad crackers?",
						Default = false
					},
				}
			},
