-- Konum: kidnap_system/lua/weapons/weapon_kidnap.lua
...
function SWEP:PrimaryAttack()
    ...
    _G.KidnapData[target] = {
        ragdoll = ragdoll,
        timer = CurTime() + 15, -- 15 saniye normal versiyon
        kidnapper = ply,
    ...
    if timer.Exists("KidnapperCheck") then
        timer.UnPause("KidnapperCheck")
    end
