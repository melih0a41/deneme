...
quadcoptersData["ez_quadcopter_dji"] = {
    equipments = {
        ...
        ["Microphone"] = {
            key = "Microphone",
            name = easzy.quadcopter.languages.microphone,
            bodygroup = "",
            value = "",
            price = 500,
            description = easzy.quadcopter.languages.microphoneDescription,
            customCheck = function(quadcopter, ply) return true end,
            customCheckMessage = "",
            blackList = {},
            information = easzy.quadcopter.languages.microphoneInformation
        }
    },
    colors = {
        ["Propellers"] = {
    ...
    upgrades = {
        ...
        ["Ghost"] = {
            key = "Ghost",
            name = easzy.quadcopter.languages.ghost or "Hayalet Mod",
            description = easzy.quadcopter.languages.ghostDescription or "Drone proplardan ve camlardan geçebilir.",
            levels = {0, 1},
            prices = {1500}
        }
    }
...
if CLIENT then
    ...
    quadcoptersData["ez_quadcopter_dji"].equipments["Microphone"].icon = Material("icon16/sound_add.png")
    ...
    quadcoptersData["ez_quadcopter_dji"].upgrades["Ghost"].icon = Material("icon16/eye.png")
    ...
    quadcoptersData["ez_quadcopter_fpv"].equipments["Microphone"].icon = Material("icon16/sound_add.png")
    ...
    quadcoptersData["ez_quadcopter_fpv"].upgrades["Ghost"].icon = Material("icon16/eye.png")
end