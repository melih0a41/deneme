...
local function GetScreenMaterial(quadcopter)
    ...
    easzy.quadcopter.QuadcopterHUD(quadcopter, newTexture, 1024, 650)
...
function SWEP:Draw3D2DGui(viewModel)
    ...
    local bone = viewModel:LookupBone("dji_radio_controller")
    ...
    -- Replace material
    local subMaterialKey = table.KeyFromValue(viewModel:GetMaterials(), "easzy/ez_quadcopter/dji_radio_controller/dji_radio_controller_screen")
