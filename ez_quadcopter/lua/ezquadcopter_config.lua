...
config.language = "en" -- "en", "fr", "es", "de", "uk", "hu", "ru", "pl", "tr"
...
config.counterGravityValue = 1 -- Increase it until the drone flys and is stable in the air when not moving it
