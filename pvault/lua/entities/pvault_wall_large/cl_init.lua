...
function ENT:Initialize()
	self.room = ClientsideModel("models/freeman/vault/pvault_wallsafe_biginterior.mdl", RENDERGROUP_OPAQUE)
...
function ENT:Draw()
	...
	local centerx, centery = -30, -765

	cam.Start3D2D(Pos + Ang:Up()*11.5, Ang, 0.037)
