...
ENT.PrintName = "Standalone Vault Tall"
...
perfectVault.Core.RegisterEntity("pvault_standalone_tall", {
	-- General data
	general = {
		bagCount = {d = 3, t = "num"}, -- Max amount of money bags
		bagStart = {d = 2 , t = "num"}, -- Starting moneybags
...
"models/freeman/vault/pvault_safe_tall.mdl")