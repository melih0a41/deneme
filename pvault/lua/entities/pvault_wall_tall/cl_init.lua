...
function ENT:Initialize()
	self.room = ClientsideModel("models/freeman/vault/pvault_wallsafe_tallinterior.mdl", RENDERGROUP_OPAQUE)
...
function ENT:Draw()
	...
	cam.Start3D2D(Pos + Ang:Up()*5 + Ang:Forward()*-16, Ang, 0.05)
	...
	local centerx, centery = -30, -145

	cam.Start3D2D(Pos + Ang:Up()*1.7 + Ang:Right()*-39, Ang, 0.024)
