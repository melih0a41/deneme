...
ENT.PrintName = "Standalone Vault Large"
...
perfectVault.Core.RegisterEntity("pvault_standalone_large", {
	-- General data
	general = {
		bagCount = {d = 4, t = "num"}, -- Max amount of money bags
...
"models/freeman/vault/pvault_safe_big.mdl")