...
-- Versiyon: 2.5 - Raid iptal prop tamiri düzeltildi
...
-- ============================
-- RAID İPTAL FONKSİYONU - GÜNCELLENDİ
-- ============================
function PropHP.RaidSystem.CancelRaid(ply)
    ...
    -- TÜM PROP'LARI TAMİR ET VE FULL HP YAP - YENİ
...
-- ============================
-- TÜM PROP'LARI RESTORE ET - YENİ FONKSİYON
-- ============================
...
-- ============================
-- RAID TAMAMEN BİTİR - GÜNCELLENDİ
-- ============================
function PropHP.RaidSystem.FinalizeRaid(raidID, overrideWinner)
    ...
    -- TÜM PROP'LARI TAMİR ET VE FULL HP YAP - GÜNCELLENDİ
...
print("[PropHP] Raid sistemi yüklendi - v2.5 Raid iptal prop tamiri düzeltildi")