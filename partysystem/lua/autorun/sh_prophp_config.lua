...
-- ============================
PropHP.Config.MinPropHP = 1000  -- Bir prop'un minimum HP'si
...
-- ============================
PropHP.Config.Raid = {
    MinPartyMembers = 1,         -- Minimum online parti üyesi
    MaxMemberDifference = 3,     -- Maksimum üye farkı
    PreparationTime = 30,        -- Hazırlık süresi (1 dakika)
    RaidDuration = 600,         -- Raid süresi (30 dakika)
    RaidCooldown = 900,         -- Aynı partiye raid cooldown (2 saat)
...
if SERVER then
    print("[PropHP] Konfigürasyon dosyası yüklendi - v2.3")
else
    print("[PropHP] Client konfigürasyon yüklendi - v2.3")
end