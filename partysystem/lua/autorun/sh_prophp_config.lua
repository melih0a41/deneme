...
PropHP.Config.Raid = {
    ...
    PreparationTime = 60,        -- Hazırlık süresi (1 dakika test için)
    ...
    -- Glow Ayarları (GERÇEK GLOW)
    UseRaidGlow = true,          -- Raid glow sistemini kullan
    TeamGlowSize = 5,            -- Takım glow boyutu (1-10 arası)
    TeamGlowPasses = 2,          -- Takım glow kalınlığı (1-5 arası)
    EnemyGlowSize = 5,           -- Düşman glow boyutu (1-10 arası)
    EnemyGlowPasses = 2,         -- Düşman glow kalınlığı (1-5 arası)
