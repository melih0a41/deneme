...
MinigameObject = MinigameObject or {}
...
-- SORUN BURADAYDI! MinigameObject'i nil yapmak yerine, 
-- global scope'da bırakıp kopyasını alalım
_G.MinigameObject = MinigameObject
local LocalizedGameScript = table.Copy(MinigameObject)
...
-- Debug kontrol
print("[MINIGAMES] Base.lua yüklendi, MinigameObject:", MinigameObject and "HAZIR" or "YOK")