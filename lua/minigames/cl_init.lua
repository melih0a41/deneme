...
Minigames.CYAN = Color(74, 158, 197)
...
function Minigames.ReceiveMessage()
    ...
    chat.AddText(color_white, "[", Minigames.CYAN, prefix, color_white, "] ", msg)
end
...
function Minigames.ReceiveBroadcast()
    local owner = net.ReadPlayer()

    local phrase = Minigames.StringFormat( Minigames.GetPhrase("playerlist.broadcast.join"), owner, string.Replace(Minigames.Config["JoinGameCommand"], "{id}", owner:UserID()) )

    chat.AddText(color_white, "[", Minigames.CYAN, "Minigames", color_white, "] ", phrase)
end

net.Receive("Minigames.Message", Minigames.ReceiveMessage)
net.Receive("Minigames.ToolTip", Minigames.ReceiveToolTip)
net.Receive("Minigames.BroadcastGameJoin", Minigames.ReceiveBroadcast)