...
if SERVER then
    ...
    -- VIP duyurusu için network string
        ...
        timer.Simple(0.1, function()
            ...
            for i, package in ipairs(vipPackages) do
                ...
                card.Paint = function(s, w, h)
                    ...
                    -- Önce siyah gölge
                    draw.SimpleText(package.name, "DermaLarge", w/2 + 2, 42, Color(0, 0, 0, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    
                    -- Sonra beyaz yazı (tüm paketler için)
                    draw.SimpleText(package.name, "DermaLarge", w/2, 40, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    
                    -- Alternatif: Açık renkli paketler için koyu yazı
                    if package.name == "VIP Silver" or package.name == "VIP Platinum" or package.name == "VIP Diamond" then
                        -- Önce beyaz kontur
                        for i = -2, 2 do
                            for j = -2, 2 do
                                if i ~= 0 or j ~= 0 then
                                    draw.SimpleText(package.name, "DermaLarge", w/2 + i, 40 + j, Color(255, 255, 255, 100), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                                end
                            end
                        end
                        -- Sonra siyah yazı
                        draw.SimpleText(package.name, "DermaLarge", w/2, 40, Color(20, 20, 20, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                    end
                end
                ...
                buyBtn.DoClick = function()
                    ...
                    infoPanel.Paint = function(s, w, h)
                        ...
                        draw.SimpleText("Paketi almak için aşağıdaki adımları takip edin", "DermaDefaultBold", w/2, contentY + 50, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                        ...
                        draw.SimpleText("Magazadan " .. package.name .. " paketini secin ve sepete ekleyin", "DermaDefaultBold", 120, step2Y + 20, Color(220, 220, 220), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
