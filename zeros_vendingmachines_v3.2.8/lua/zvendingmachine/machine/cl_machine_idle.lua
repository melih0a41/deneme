...
function zvm.Machine.ChangeDisplayedProduct(Machine)
	...
	if Machine.Idle_ProductData then
		...
		Machine.Idle_ProductData.money = zvm.Money.Display(Machine.Idle_ProductData.price,zvm.Money.GetSymbol(Machine.MoneyType))
...
function zvm.Machine.ProductImage(Machine)
	...
	local CustomUpdate = zvm.Module.IdleImageOverwrite(Machine.Idle_ProductData.class, Machine.Idle_ProductData, Machine.VGUI.ProductImage)
